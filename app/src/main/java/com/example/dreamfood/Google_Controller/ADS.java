package com.example.dreamfood.Google_Controller;
...
import com.example.dreamfood.databinding.ActivityAdsBinding;
...
public class ADS extends AppCompatActivity {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_a_d, menu);
        return true;
    }
        ...
        InterstitialAd.load(this, getString(R.string.interstitial_ad_unit_id), adRequest,
                new InterstitialAdLoadCallback() {
                    ...
                    public void onAdLoaded(@NonNull InterstitialAd interstitialAd) {
                        ...
                        Toast.makeText(ADS.this, "onAdLoaded()", Toast.LENGTH_SHORT).show();
