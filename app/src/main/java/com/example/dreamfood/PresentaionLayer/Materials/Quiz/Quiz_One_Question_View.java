 ...
 */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String student_json=getIntent().getStringExtra(constants.student);
         student=gson.fromJson(student_json,Student.class);
        initWidgets();

    }
    /*
    init views and buttons listeners
     */
         ...
         submit.setOnClickListener(new View.OnClickListener() {
             ...
             public void onClick(View v) {
                 if(v==submit){
                     ...
                     FirebaseDatabase.getInstance().getReference(constants.student).child(student.getEmail()).setValue(student);
