            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for (DataSnapshot snapshot1 : snapshot.getChildren()) {
                    try {
                        ...
                        if(snapshot1.getKey().equals(userEmail)){
                ...
                dataAdapter = new ArrayAdapter<String>(Quiz_result.this, android.R.layout.simple_list_item_1, jobs);
                spinner.setAdapter(dataAdapter);
                spinner.setOnItemSelectedListener(Quiz_result.this);
            }
