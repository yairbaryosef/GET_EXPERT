package com.example.dreamfood.PresentaionLayer.Layouts_Controllers.Animation;
...
public class anim {
    ...
    TextView grade;
    /*
    generate a dialog that show the counter anim
     */
    ...
    /*
     counter anim helper
     */
    private void startCounterAnim(double number){
